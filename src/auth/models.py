...
class UsersModel(Base):
    ...
    # It tells SQLAlchemy to link Python object properties together based on the
    ...
    # - user.role returns the full RolesModel object associated with
    # that user (user.role.type, user.role.name).
