...
# # The "autocommit" and "autoflush" parameters are set to False
# to ensure more control over transactions.
async_session_maker = async_sessionmaker(
    bind=engine, class_=AsyncSession, autoflush=False, autocommit=False, expire_on_commit=False
)

# # The "declarative_base" function serves as the base class
# for declarative models that will be created later.
