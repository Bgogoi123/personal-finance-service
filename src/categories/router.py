...
async def get_all_categories(session: session_dependency, user: UsersModel = Depends(allow_all)):
...
async def get_category_by_id(id: str, session: session_dependency, user: UsersModel = Depends(allow_all)):
...
async def update_category_by_id(id: str, body: CategoryUpdateSchema, session: session_dependency, user: UsersModel = Depends(allow_all)):
...
async def delete_category_by_id(id: str, session: session_dependency, user: UsersModel = Depends(allow_all)):
